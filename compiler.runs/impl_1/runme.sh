...
HD_PWD='/home/jgarci/Documents/compiler/compiler.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Unite_de_controle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Unite_de_controle.tcl -notrace
