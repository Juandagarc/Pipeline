...
HD_PWD='/home/jgarci/Documents/compiler/compiler.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Unite_de_controle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Unite_de_controle.tcl
